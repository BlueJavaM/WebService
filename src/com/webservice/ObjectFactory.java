...
public class ObjectFactory {
    ...
    private final static QName _GetName_QNAME = new QName("http://interfaces.example/", "getName");
    private final static QName _GetNameResponse_QNAME = new QName("http://interfaces.example/", "getNameResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces.example/", name = "getName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces.example/", name = "getNameResponse")
